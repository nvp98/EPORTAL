...
{
    public class VirtualGroupController : Controller
    {
        EPORTALEntities db = new EPORTALEntities();
        PhanQuyenHTEntities dbP = new PhanQuyenHTEntities();
        int IDQuyenHT = EPORTAL.Models.MyAuthentication.IDQuyenHT;
        String controll = "VirtualGroup";
        // GET: View360/VirtualGroup
        public ActionResult Index()
        {
            ...
            var model = db.VirtualGroups.ToList();
            return View(model);
        }
        ...
        public ActionResult Create(ProjectsGroupValidation _DO)
        {
            ...
            try
            {
                var a = db.VirtualGroup_insert(_DO.GroupName);
            ...
            //return View();
            return RedirectToAction("Index", "VirtualGroup");
        }
        public ActionResult Edit(int id)
        {
            ...
            var res = (from a in db.VirtualGroups.Where(x => x.IDGroup == id)
        ...
        public ActionResult Edit(ProjectsGroupValidation _DO)
        {
            ...
            try
            {
                var a = db.VirtualGroup_update(_DO.IDGroup, _DO.GroupName);
